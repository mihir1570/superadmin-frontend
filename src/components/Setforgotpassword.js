...
import forgetpage_img from './img/forgetpage_img.jpg'
import forgetpage_img_long from './img/forgetpage_img_long.jpg'
                  ...
                  <div className="card shadow-lg rounded-3">
                    <div className="row g-0">
                      <div className="col-md-6 col-lg-5 d-none d-md-block">
                        <img src={forgetpage_img_long} alt="login form" className="img-fluid card-img-top rounded-start" style={{ objectFit: "cover", height: "100%", borderRadius: "1rem 0 0 1rem" }} />
                      </div>
                        ...
                        <div className="card-body p-4 p-lg-5 text-black">
                          ...
                          <form>
                            ...
                            <div className="d-flex align-items-center mb-3 pb-1">
                              <h1 className="fw-bold mb-0">Reset Password</h1>
                            </div>
